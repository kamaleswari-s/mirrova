...
export default function AppLayout() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: c.bg, transition: 'background 0.3s', overflow: 'hidden' }}>
      ...
      {/* Main content */}
      <main style={{ flex: 1, overflowY: 'auto', height: '100vh', display: 'flex', justifyContent: 'center', paddingBottom: 0 }}
        className="app-main">
        <div style={{ width: '100%', maxWidth: 1100, minWidth: 0, paddingBottom: 80 }}>
          <Outlet />
        </div>
      </main>
